...
Defines the user interface for credential management in Keykeep: creation wizard, key type detection, password generation, reveal dialog, standalone credential views, and the redesigned credentials tab in subscription forms.
